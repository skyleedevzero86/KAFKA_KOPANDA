<template>
  <div class="topic-detail-view">
    <div v-if="!topic" class="no-topic">
      <el-empty description="토픽 정보가 없습니다" />
    </div>
    ...
    <div v-else class="topic-detail">
      ...
      <div v-if="topic.partitions && topic.partitions.length > 0" style="margin-top: 20px;">
        <h4>파티션 상세 정보</h4>
      ...
      <div v-if="topic.config && Object.keys(topic.config).length > 0" style="margin-top: 20px;">
        <h4>토픽 설정</h4>
